...
def visDerivatives(I_gray, Mag, Magx, Magy):
  ...
  axes[0,0].imshow(Mag, cmap='gray', interpolation='nearest')
  axes[0,0].axis('off')
  axes[0,0].set_title('Gradient Magnitude')

  axes[0,1].imshow(Magx, cmap='gray', interpolation='nearest')
  axes[0,1].axis('off')
  axes[0,1].set_title('Gradient Magnitude (x axis)')
  
  axes[1,0].imshow(Magy, cmap='gray', interpolation='nearest')
  axes[1,0].axis('off')
  axes[1,0].set_title('Gradient Magnitude (y axis)')
  ...
  axes[1,1].imshow(I_gray, cmap='gray', interpolation='nearest')
  axes[1,1].axis('off')
